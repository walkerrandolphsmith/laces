...
$ npm install --save @laces/XXXXXXXX
```
...
const XXXXXXXX = require('@laces/XXXXXXXX')
```

For additional documentation please use the 
[documentation site](https://walkerrandolphsmith.com/laces)
...
[npm]: https://www.npmjs.org/package/@laces/XXXXXXXX
[npm-badge]: https://img.shields.io/npm/v/@laces/XXXXXXXX.svg
