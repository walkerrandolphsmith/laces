...
$ npm install --save @quillio/stringy-XXXXXXXX
```
...
const XXXXXXXX = require('@quillio/stringy-XXXXXXXX')
```
...
[npm]: https://www.npmjs.org/package/@quillio/stringy-XXXXXXXX
[npm-badge]: https://img.shields.io/npm/v/@quillio/stringy-XXXXXXXX.svg
