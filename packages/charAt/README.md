...
$ npm install --save @quillio/stringy-charAt
```
...
const charAt = require('@quillio/stringy-charAt')
```
...
[npm]: https://www.npmjs.org/package/@quillio/stringy-charAt
[npm-badge]: https://img.shields.io/npm/v/@quillio/stringy-charAt.svg
