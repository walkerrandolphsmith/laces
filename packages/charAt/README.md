...
$ npm install --save @laces/laces-charAt
```
...
const charAt = require('@laces/laces-charAt')
```
...
[npm]: https://www.npmjs.org/package/@laces/laces-charAt
[npm-badge]: https://img.shields.io/npm/v/@laces/laces-charAt.svg
