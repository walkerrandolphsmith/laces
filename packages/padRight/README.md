...
$ npm install --save @laces/laces-padRight
```
...
const padRight = require('@laces/laces-padRight')
```
...
[npm]: https://www.npmjs.org/package/@laces/laces-padRight
[npm-badge]: https://img.shields.io/npm/v/@laces/laces-padRight.svg
