...
$ npm install --save @quillio/stringy-padRight
```
...
const padRight = require('@quillio/stringy-padRight')
```
...
[npm]: https://www.npmjs.org/package/@quillio/stringy-padRight
[npm-badge]: https://img.shields.io/npm/v/@quillio/stringy-padRight.svg
