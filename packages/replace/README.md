...
$ npm install --save @laces/laces-replace
```
...
const replace = require('@laces/laces-replace')
```
...
[npm]: https://www.npmjs.org/package/@laces/laces-replace
[npm-badge]: https://img.shields.io/npm/v/@laces/laces-replace.svg
