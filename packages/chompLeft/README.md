...
$ npm install --save @laces/laces-chompLeft
```
...
const chompLeft = require('@laces/laces-chompLeft')
```
...
[npm]: https://www.npmjs.org/package/@laces/laces-chompLeft
[npm-badge]: https://img.shields.io/npm/v/@laces/laces-chompLeft.svg
