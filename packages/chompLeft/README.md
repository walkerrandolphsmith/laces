...
$ npm install --save @quillio/stringy-chompLeft
```
...
const chompLeft = require('@quillio/stringy-chompLeft')
```
...
[npm]: https://www.npmjs.org/package/@quillio/stringy-chompLeft
[npm-badge]: https://img.shields.io/npm/v/@quillio/stringy-chompLeft.svg
