...
$ npm install --save @laces/laces-isAlphaNumeric
```
...
const isAlphaNumeric = require('@laces/laces-isAlphaNumeric')
```
...
[npm]: https://www.npmjs.org/package/@laces/laces-isAlphaNumeric
[npm-badge]: https://img.shields.io/npm/v/@laces/laces-isAlphaNumeric.svg
