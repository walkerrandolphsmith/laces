...
$ npm install --save @quillio/stringy-isAlphaNumeric
```
...
const isAlphaNumeric = require('@quillio/stringy-isAlphaNumeric')
```
...
[npm]: https://www.npmjs.org/package/@quillio/stringy-isAlphaNumeric
[npm-badge]: https://img.shields.io/npm/v/@quillio/stringy-isAlphaNumeric.svg
