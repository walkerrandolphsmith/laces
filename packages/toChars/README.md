...
$ npm install --save @quillio/stringy-toChars
```
...
const toChars = require('@quillio/stringy-toChars')
```
...
[npm]: https://www.npmjs.org/package/@quillio/stringy-toChars
[npm-badge]: https://img.shields.io/npm/v/@quillio/stringy-toChars.svg
