...
$ npm install --save @laces/laces-toChars
```
...
const toChars = require('@laces/laces-toChars')
```
...
[npm]: https://www.npmjs.org/package/@laces/laces-toChars
[npm-badge]: https://img.shields.io/npm/v/@laces/laces-toChars.svg
