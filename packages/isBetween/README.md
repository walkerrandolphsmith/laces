...
$ npm install --save @laces/laces-isBetween
```
...
const isBetween = require('@laces/laces-isBetween')
```
...
[npm]: https://www.npmjs.org/package/@laces/laces-isBetween
[npm-badge]: https://img.shields.io/npm/v/@laces/laces-isBetween.svg
