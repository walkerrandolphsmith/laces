...
$ npm install --save @quillio/stringy-isBetween
```
...
const isBetween = require('@quillio/stringy-isBetween')
```
...
[npm]: https://www.npmjs.org/package/@quillio/stringy-isBetween
[npm-badge]: https://img.shields.io/npm/v/@quillio/stringy-isBetween.svg
