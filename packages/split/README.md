...
$ npm install --save @quillio/stringy-split
```
...
const split = require('@quillio/stringy-split')
```
...
[npm]: https://www.npmjs.org/package/@quillio/stringy-split
[npm-badge]: https://img.shields.io/npm/v/@quillio/stringy-split.svg
