...
$ npm install --save @laces/laces-split
```
...
const split = require('@laces/laces-split')
```
...
[npm]: https://www.npmjs.org/package/@laces/laces-split
[npm-badge]: https://img.shields.io/npm/v/@laces/laces-split.svg
