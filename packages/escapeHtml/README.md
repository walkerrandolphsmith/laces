...
$ npm install --save @quillio/stringy-escapeHtml
```
...
const escapeHtml = require('@quillio/stringy-escapeHtml')
```
...
[npm]: https://www.npmjs.org/package/@quillio/stringy-escapeHtml
[npm-badge]: https://img.shields.io/npm/v/@quillio/stringy-escapeHtml.svg
