...
$ npm install --save @laces/laces-escapeHtml
```
...
const escapeHtml = require('@laces/laces-escapeHtml')
```
...
[npm]: https://www.npmjs.org/package/@laces/laces-escapeHtml
[npm-badge]: https://img.shields.io/npm/v/@laces/laces-escapeHtml.svg
