...
$ npm install --save @laces/laces-template
```
...
const template = require('@laces/laces-template')
```
...
[npm]: https://www.npmjs.org/package/@laces/laces-template
[npm-badge]: https://img.shields.io/npm/v/@laces/laces-template.svg
