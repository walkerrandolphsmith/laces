...
$ npm install --save @quillio/stringy-toKebabCase
```
...
const toKebabCase = require('@quillio/stringy-toKebabCase')
```
...
[npm]: https://www.npmjs.org/package/@quillio/stringy-toKebabCase
[npm-badge]: https://img.shields.io/npm/v/@quillio/stringy-toKebabCase.svg
