...
$ npm install --save @laces/laces-isNumeric
```
...
const isNumeric = require('@laces/laces-isNumeric')
```
...
[npm]: https://www.npmjs.org/package/@laces/laces-isNumeric
[npm-badge]: https://img.shields.io/npm/v/@laces/laces-isNumeric.svg
