...
$ npm install --save @quillio/stringy-isNumeric
```
...
const isNumeric = require('@quillio/stringy-isNumeric')
```
...
[npm]: https://www.npmjs.org/package/@quillio/stringy-isNumeric
[npm-badge]: https://img.shields.io/npm/v/@quillio/stringy-isNumeric.svg
