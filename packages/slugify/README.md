...
$ npm install --save @laces/laces-slugify
```
...
const slugify = require('@laces/laces-slugify')
```
...
[npm]: https://www.npmjs.org/package/@laces/laces-slugify
[npm-badge]: https://img.shields.io/npm/v/@laces/laces-slugify.svg
