...
$ npm install --save @laces/laces-isNaturalNumber
```
...
const isNaturalNumber = require('@laces/laces-isNaturalNumber')
```
...
[npm]: https://www.npmjs.org/package/@laces/laces-isNaturalNumber
[npm-badge]: https://img.shields.io/npm/v/@laces/laces-isNaturalNumber.svg
