...
$ npm install --save @quillio/stringy-isNaturalNumber
```
...
const isNaturalNumber = require('@quillio/stringy-isNaturalNumber')
```
...
[npm]: https://www.npmjs.org/package/@quillio/stringy-isNaturalNumber
[npm-badge]: https://img.shields.io/npm/v/@quillio/stringy-isNaturalNumber.svg
