...
$ npm install --save @laces/laces-latinise
```
...
const latinise = require('@laces/laces-latinise')
```
...
[npm]: https://www.npmjs.org/package/@laces/laces-latinise
[npm-badge]: https://img.shields.io/npm/v/@laces/laces-latinise.svg
