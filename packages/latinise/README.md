...
$ npm install --save @quillio/stringy-latinise
```
...
const latinise = require('@quillio/stringy-latinise')
```
...
[npm]: https://www.npmjs.org/package/@quillio/stringy-latinise
[npm-badge]: https://img.shields.io/npm/v/@quillio/stringy-latinise.svg
