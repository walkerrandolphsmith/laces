...
$ npm install --save @quillio/stringy-chompRight
```
...
const chompRight = require('@quillio/stringy-chompRight')
```
...
[npm]: https://www.npmjs.org/package/@quillio/stringy-chompRight
[npm-badge]: https://img.shields.io/npm/v/@quillio/stringy-chompRight.svg
