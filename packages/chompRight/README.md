...
$ npm install --save @laces/laces-chompRight
```
...
const chompRight = require('@laces/laces-chompRight')
```
...
[npm]: https://www.npmjs.org/package/@laces/laces-chompRight
[npm-badge]: https://img.shields.io/npm/v/@laces/laces-chompRight.svg
