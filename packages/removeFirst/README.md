...
$ npm install --save @quillio/stringy-removeFirst
```
...
const removeFirst = require('@quillio/stringy-removeFirst')
```
...
[npm]: https://www.npmjs.org/package/@quillio/stringy-removeFirst
[npm-badge]: https://img.shields.io/npm/v/@quillio/stringy-removeFirst.svg
