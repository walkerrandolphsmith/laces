...
$ npm install --save @laces/laces-removeFirst
```
...
[npm]: https://www.npmjs.org/package/@laces/laces-removeFirst
[npm-badge]: https://img.shields.io/npm/v/@laces/laces-removeFirst.svg
