...
$ npm install --save @laces/laces-capitalize
```
...
const capitalize = require('@laces/laces-capitalize')
```
...
[npm]: https://www.npmjs.org/package/@laces/laces-capitalize
[npm-badge]: https://img.shields.io/npm/v/@laces/laces-capitalize.svg
