...
$ npm install --save @quillio/stringy-capitalize
```
...
const capitalize = require('@quillio/stringy-capitalize')
```
...
[npm]: https://www.npmjs.org/package/@quillio/stringy-capitalize
[npm-badge]: https://img.shields.io/npm/v/@quillio/stringy-capitalize.svg
