...
$ npm install --save @laces/laces-clamp
```
...
const clamp = require('@laces/laces-clamp')
```
...
[npm]: https://www.npmjs.org/package/@laces/laces-clamp
[npm-badge]: https://img.shields.io/npm/v/@laces/laces-clamp.svg
