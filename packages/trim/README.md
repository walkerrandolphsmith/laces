...
$ npm install --save @quillio/stringy-trim
```
...
const trim = require('@quillio/stringy-trim')
```
...
[npm]: https://www.npmjs.org/package/@quillio/stringy-trim
[npm-badge]: https://img.shields.io/npm/v/@quillio/stringy-trim.svg
