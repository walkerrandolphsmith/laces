...
$ npm install --save @quillio/stringy-escapeRegex
```
...
const escapeRegex = require('@quillio/stringy-escapeRegex')
```
...
[npm]: https://www.npmjs.org/package/@quillio/stringy-escapeRegex
[npm-badge]: https://img.shields.io/npm/v/@quillio/stringy-escapeRegex.svg
