...
$ npm install --save @laces/laces-takeWhile
```
...
const takeWhile = require('@laces/laces-takeWhile')
```
...
[npm]: https://www.npmjs.org/package/@laces/laces-takeWhile
[npm-badge]: https://img.shields.io/npm/v/@laces/laces-takeWhile.svg
