...
$ npm install --save @laces/laces-reverse
```
...
const reverse = require('@laces/laces-reverse')
```
...
[npm]: https://www.npmjs.org/package/@laces/laces-reverse
[npm-badge]: https://img.shields.io/npm/v/@laces/laces-reverse.svg
