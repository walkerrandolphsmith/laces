...
$ npm install --save @quillio/stringy-reverse
```
...
const reverse = require('@quillio/stringy-reverse')
```
...
[npm]: https://www.npmjs.org/package/@quillio/stringy-reverse
[npm-badge]: https://img.shields.io/npm/v/@quillio/stringy-reverse.svg
