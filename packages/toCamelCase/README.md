...
$ npm install --save @quillio/stringy-toCamelCase
```
...
const toCamelCase = require('@quillio/stringy-toCamelCase')
```
...
[npm]: https://www.npmjs.org/package/@quillio/stringy-toCamelCase
[npm-badge]: https://img.shields.io/npm/v/@quillio/stringy-toCamelCase.svg
