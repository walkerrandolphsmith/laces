...
$ npm install --save @laces/laces-toCamelCase
```
...
const toCamelCase = require('@laces/laces-toCamelCase')
```
...
[npm]: https://www.npmjs.org/package/@laces/laces-toCamelCase
[npm-badge]: https://img.shields.io/npm/v/@laces/laces-toCamelCase.svg
