...
$ npm install --save @laces/laces-toSpaceCase
```
...
const toSpaceCase = require('@laces/laces-toSpaceCase')
```
...
[npm]: https://www.npmjs.org/package/@laces/laces-toSpaceCase
[npm-badge]: https://img.shields.io/npm/v/@laces/laces-toSpaceCase.svg
