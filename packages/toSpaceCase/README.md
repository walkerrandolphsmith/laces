...
$ npm install --save @quillio/stringy-toSpaceCase
```
...
const toSpaceCase = require('@quillio/stringy-toSpaceCase')
```
...
[npm]: https://www.npmjs.org/package/@quillio/stringy-toSpaceCase
[npm-badge]: https://img.shields.io/npm/v/@quillio/stringy-toSpaceCase.svg
