...
$ npm install --save @quillio/stringy-padLeft
```
...
const padLeft = require('@quillio/stringy-padLeft')
```
...
[npm]: https://www.npmjs.org/package/@quillio/stringy-padLeft
[npm-badge]: https://img.shields.io/npm/v/@quillio/stringy-padLeft.svg
