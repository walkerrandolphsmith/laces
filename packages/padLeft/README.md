...
$ npm install --save @laces/laces-padLeft
```
...
const padLeft = require('@laces/laces-padLeft')
```
...
[npm]: https://www.npmjs.org/package/@laces/laces-padLeft
[npm-badge]: https://img.shields.io/npm/v/@laces/laces-padLeft.svg
