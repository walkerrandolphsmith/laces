...
$ npm install --save @quillio/stringy-chain
```
...
const chain = require('@quillio/stringy-chain')
```
...
[npm]: https://www.npmjs.org/package/@quillio/stringy-chain
[npm-badge]: https://img.shields.io/npm/v/@quillio/stringy-chain.svg
