...
$ npm install --save @laces/laces-chain
```
...
const chain = require('@laces/laces-chain')
```
...
[npm]: https://www.npmjs.org/package/@laces/laces-chain
[npm-badge]: https://img.shields.io/npm/v/@laces/laces-chain.svg
