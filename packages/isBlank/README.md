...
$ npm install --save @quillio/stringy-isBlank
```
...
const isBlank = require('@quillio/stringy-isBlank')
```
...
[npm]: https://www.npmjs.org/package/@quillio/stringy-isBlank
[npm-badge]: https://img.shields.io/npm/v/@quillio/stringy-isBlank.svg
