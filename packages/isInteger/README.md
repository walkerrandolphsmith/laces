...
$ npm install --save @quillio/stringy-isInteger
```
...
const isInteger = require('@quillio/stringy-isInteger')
```
...
[npm]: https://www.npmjs.org/package/@quillio/stringy-isInteger
[npm-badge]: https://img.shields.io/npm/v/@quillio/stringy-isInteger.svg
