...
$ npm install --save @laces/laces-isInteger
```
...
const isInteger = require('@laces/laces-isInteger')
```
...
[npm]: https://www.npmjs.org/package/@laces/laces-isInteger
[npm-badge]: https://img.shields.io/npm/v/@laces/laces-isInteger.svg
