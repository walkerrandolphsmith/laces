...
$ npm install --save @quillio/stringy-toCodePoints
```
...
const toCodePoints = require('@quillio/stringy-toCodePoints')
```
...
[npm]: https://www.npmjs.org/package/@quillio/stringy-toCodePoints
[npm-badge]: https://img.shields.io/npm/v/@quillio/stringy-toCodePoints.svg
