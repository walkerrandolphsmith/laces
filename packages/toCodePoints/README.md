...
$ npm install --save @laces/laces-toCodePoints
```
...
const toCodePoints = require('@laces/laces-toCodePoints')
```
...
[npm]: https://www.npmjs.org/package/@laces/laces-toCodePoints
[npm-badge]: https://img.shields.io/npm/v/@laces/laces-toCodePoints.svg
