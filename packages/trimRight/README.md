...
$ npm install --save @quillio/stringy-trimRight
```
...
const trimRight = require('@quillio/stringy-trimRight')
```
...
[npm]: https://www.npmjs.org/package/@quillio/stringy-trimRight
[npm-badge]: https://img.shields.io/npm/v/@quillio/stringy-trimRight.svg
