...
$ npm install --save @laces/laces-trimRight
```
...
const trimRight = require('@laces/laces-trimRight')
```
...
[npm]: https://www.npmjs.org/package/@laces/laces-trimRight
[npm-badge]: https://img.shields.io/npm/v/@laces/laces-trimRight.svg
