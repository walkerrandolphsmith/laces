...
$ npm install --save @quillio/stringy-remove
```
...
const remove = require('@quillio/stringy-remove')
```
...
[npm]: https://www.npmjs.org/package/@quillio/stringy-remove
[npm-badge]: https://img.shields.io/npm/v/@quillio/stringy-remove.svg
