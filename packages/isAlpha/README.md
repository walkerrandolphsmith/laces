...
$ npm install --save @laces/laces-isAlpha
```
...
const isAlpha = require('@laces/laces-isAlpha')
```
...
[npm]: https://www.npmjs.org/package/@laces/laces-isAlpha
[npm-badge]: https://img.shields.io/npm/v/@laces/laces-isAlpha.svg
