...
$ npm install --save @quillio/stringy-isAlpha
```
...
const isAlpha = require('@quillio/stringy-isAlpha')
```
...
[npm]: https://www.npmjs.org/package/@quillio/stringy-isAlpha
[npm-badge]: https://img.shields.io/npm/v/@quillio/stringy-isAlpha.svg
