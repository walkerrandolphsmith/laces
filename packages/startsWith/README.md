...
$ npm install --save @quillio/stringy-startsWith
```
...
const startsWith = require('@quillio/stringy-startsWith')
```
...
[npm]: https://www.npmjs.org/package/@quillio/stringy-startsWith
[npm-badge]: https://img.shields.io/npm/v/@quillio/stringy-startsWith.svg
