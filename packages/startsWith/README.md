...
$ npm install --save @laces/laces-startsWith
```
...
const startsWith = require('@laces/laces-startsWith')
```
...
[npm]: https://www.npmjs.org/package/@laces/laces-startsWith
[npm-badge]: https://img.shields.io/npm/v/@laces/laces-startsWith.svg
