...
$ npm install --save @quillio/stringy-isMatch
```
...
const isMatch = require('@quillio/stringy-isMatch')
```
...
[npm]: https://www.npmjs.org/package/@quillio/stringy-isMatch
[npm-badge]: https://img.shields.io/npm/v/@quillio/stringy-isMatch.svg
