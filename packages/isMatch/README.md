...
$ npm install --save @laces/laces-isMatch
```
...
const isMatch = require('@laces/laces-isMatch')
```
...
[npm]: https://www.npmjs.org/package/@laces/laces-isMatch
[npm-badge]: https://img.shields.io/npm/v/@laces/laces-isMatch.svg
