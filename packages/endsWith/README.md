...
$ npm install --save @quillio/stringy-endsWith
```
...
const endsWith = require('@quillio/stringy-endsWith')
```
...
[npm]: https://www.npmjs.org/package/@quillio/stringy-endsWith
[npm-badge]: https://img.shields.io/npm/v/@quillio/stringy-endsWith.svg
