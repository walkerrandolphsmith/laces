...
$ npm install --save @laces/laces-endsWith
```
...
const endsWith = require('@laces/laces-endsWith')
```
...
[npm]: https://www.npmjs.org/package/@laces/laces-endsWith
[npm-badge]: https://img.shields.io/npm/v/@laces/laces-endsWith.svg
