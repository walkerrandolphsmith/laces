...
$ npm install --save @quillio/stringy-toUpperCase
```
...
const toUpperCase = require('@quillio/stringy-toUpperCase')
```
...
[npm]: https://www.npmjs.org/package/@quillio/stringy-toUpperCase
[npm-badge]: https://img.shields.io/npm/v/@quillio/stringy-toUpperCase.svg
