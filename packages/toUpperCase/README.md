...
$ npm install --save @laces/laces-toUpperCase
```
...
const toUpperCase = require('@laces/laces-toUpperCase')
```
...
[npm]: https://www.npmjs.org/package/@laces/laces-toUpperCase
[npm-badge]: https://img.shields.io/npm/v/@laces/laces-toUpperCase.svg
