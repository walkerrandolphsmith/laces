...
$ npm install --save @laces/laces-toLines
```
...
const toLines = require('@laces/laces-toLines')
```
...
[npm]: https://www.npmjs.org/package/@laces/laces-toLines
[npm-badge]: https://img.shields.io/npm/v/@laces/laces-toLines.svg
