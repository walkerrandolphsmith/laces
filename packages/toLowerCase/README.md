...
$ npm install --save @quillio/stringy-toLowerCase
```
...
const toLowerCase = require('@quillio/stringy-toLowerCase')
```
...
[npm]: https://www.npmjs.org/package/@quillio/stringy-toLowerCase
[npm-badge]: https://img.shields.io/npm/v/@quillio/stringy-toLowerCase.svg
