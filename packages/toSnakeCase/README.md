...
$ npm install --save @laces/laces-toSnakeCase
```
...
const toSnakeCase = require('@laces/laces-toSnakeCase')
```
...
[npm]: https://www.npmjs.org/package/@laces/laces-toSnakeCase
[npm-badge]: https://img.shields.io/npm/v/@laces/laces-toSnakeCase.svg
