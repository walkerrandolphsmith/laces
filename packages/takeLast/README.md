...
$ npm install --save @quillio/stringy-takeLast
```
...
const takeLast = require('@quillio/stringy-takeLast')
```
...
[npm]: https://www.npmjs.org/package/@quillio/stringy-takeLast
[npm-badge]: https://img.shields.io/npm/v/@quillio/stringy-takeLast.svg
