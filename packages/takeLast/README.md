...
$ npm install --save @laces/laces-takeLast
```
...
const takeLast = require('@laces/laces-takeLast')
```
...
[npm]: https://www.npmjs.org/package/@laces/laces-takeLast
[npm-badge]: https://img.shields.io/npm/v/@laces/laces-takeLast.svg
