...
$ npm install --save @laces/laces-stringy-functions
```
...
const stringy-functions = require('@laces/laces-stringy-functions')
```
...
[npm]: https://www.npmjs.org/package/@laces/laces-stringy-functions
[npm-badge]: https://img.shields.io/npm/v/@laces/laces-stringy-functions.svg
