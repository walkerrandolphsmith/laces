...
$ npm install --save @laces/laces-trimLeft
```
...
const trimLeft = require('@laces/laces-trimLeft')
```
...
[npm]: https://www.npmjs.org/package/@laces/laces-trimLeft
[npm-badge]: https://img.shields.io/npm/v/@laces/laces-trimLeft.svg
