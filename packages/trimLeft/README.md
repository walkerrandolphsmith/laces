...
$ npm install --save @quillio/stringy-trimLeft
```
...
const trimLeft = require('@quillio/stringy-trimLeft')
```
...
[npm]: https://www.npmjs.org/package/@quillio/stringy-trimLeft
[npm-badge]: https://img.shields.io/npm/v/@quillio/stringy-trimLeft.svg
