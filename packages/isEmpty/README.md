...
$ npm install --save @quillio/stringy-isEmpty
```
...
const isEmpty = require('@quillio/stringy-isEmpty')
```
...
[npm]: https://www.npmjs.org/package/@quillio/stringy-isEmpty
[npm-badge]: https://img.shields.io/npm/v/@quillio/stringy-isEmpty.svg
