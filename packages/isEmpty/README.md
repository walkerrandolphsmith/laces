...
$ npm install --save @laces/laces-isEmpty
```
...
const isEmpty = require('@laces/laces-isEmpty')
```
...
[npm]: https://www.npmjs.org/package/@laces/laces-isEmpty
[npm-badge]: https://img.shields.io/npm/v/@laces/laces-isEmpty.svg
