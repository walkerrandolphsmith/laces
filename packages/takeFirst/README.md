...
$ npm install --save @quillio/stringy-takeFirst
```
...
const takeFirst = require('@quillio/stringy-takeFirst')
```
...
[npm]: https://www.npmjs.org/package/@quillio/stringy-takeFirst
[npm-badge]: https://img.shields.io/npm/v/@quillio/stringy-takeFirst.svg
