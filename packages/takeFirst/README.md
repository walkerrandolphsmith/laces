...
$ npm install --save @laces/laces-takeFirst
```
...
const takeFirst = require('@laces/laces-takeFirst')
```
...
[npm]: https://www.npmjs.org/package/@laces/laces-takeFirst
[npm-badge]: https://img.shields.io/npm/v/@laces/laces-takeFirst.svg
