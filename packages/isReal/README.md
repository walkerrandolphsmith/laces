...
$ npm install --save @quillio/stringy-isReal
```
...
const isReal = require('@quillio/stringy-isReal')
```
...
[npm]: https://www.npmjs.org/package/@quillio/stringy-isReal
[npm-badge]: https://img.shields.io/npm/v/@quillio/stringy-isReal.svg
