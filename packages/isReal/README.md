...
$ npm install --save @laces/laces-isReal
```
...
const isReal = require('@laces/laces-isReal')
```
...
[npm]: https://www.npmjs.org/package/@laces/laces-isReal
[npm-badge]: https://img.shields.io/npm/v/@laces/laces-isReal.svg
