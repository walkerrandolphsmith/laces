...
$ npm install --save @quillio/stringy-collapse
```
...
const collapse = require('@quillio/stringy-collapse')
```
...
[npm]: https://www.npmjs.org/package/@quillio/stringy-collapse
[npm-badge]: https://img.shields.io/npm/v/@quillio/stringy-collapse.svg
