...
$ npm install --save @laces/laces-collapse
```
...
const collapse = require('@laces/laces-collapse')
```
...
[npm]: https://www.npmjs.org/package/@laces/laces-collapse
[npm-badge]: https://img.shields.io/npm/v/@laces/laces-collapse.svg
