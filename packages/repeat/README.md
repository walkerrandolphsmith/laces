...
$ npm install --save @quillio/stringy-repeat
```
...
const repeat = require('@quillio/stringy-repeat')
```
...
[npm]: https://www.npmjs.org/package/@quillio/stringy-repeat
[npm-badge]: https://img.shields.io/npm/v/@quillio/stringy-repeat.svg
