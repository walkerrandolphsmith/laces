...
$ npm install --save @laces/laces-repeat
```
...
const repeat = require('@laces/laces-repeat')
```
...
[npm]: https://www.npmjs.org/package/@laces/laces-repeat
[npm-badge]: https://img.shields.io/npm/v/@laces/laces-repeat.svg
