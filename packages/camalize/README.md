...
$ npm install --save @laces/laces-camalize
```
...
[npm]: https://www.npmjs.org/package/@laces/laces-camalize
[npm-badge]: https://img.shields.io/npm/v/@laces/laces-camalize.svg
