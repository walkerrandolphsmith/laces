...
$ npm install --save @quillio/stringy-camalize
```
...
const camalize = require('@quillio/stringy-camalize')
```
...
[npm]: https://www.npmjs.org/package/@quillio/stringy-camalize
[npm-badge]: https://img.shields.io/npm/v/@quillio/stringy-camalize.svg
